...
const page = ({ fadeIn = true }) => {
  ...
  return (
    isShown && (
      <motion.div
        // variants={backgroundColor && variants2}
        initial={'hidden'}
        animate={'enter'}
        transition={{
          type: 'spring',
                ...
                <div className="w-[48.5%] flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-3">
                    <p className="text-lg">
                      ...
                      Dolorum fuga modi, inventore cupiditate natus eius
                      accusamus voluptatum iure ipsa quod tempora eaque
                      molestias impedit totam magni veniam doloribus sunt
                      praesentium.
                    </p>
